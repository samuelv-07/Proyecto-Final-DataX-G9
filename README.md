...
Repositorio oficial del proyecto final para el curso **DataXperience** de la Universidad Ean. El trabajo aborda el ciclo completo de un proyecto de ciencia de datos aplicado al análisis de biodiversidad, integrando la limpieza de datos, análisis exploratorio (EDA), hallazgos estadísticos y un componente de modelado con bases de datos orientadas a grafos y modelos de lenguaje (LLM).

## 👥 Integrantes del Grupo 09
* Samuel Vanegas Suárez
* Juan Diego Vega Pongeuta
* Mariana Mancera Gómez
* Jerónimo Suárez Acosta
